...
public class EnrollmentSystemGUI extends JFrame {
    ...
    private void initializeInitialDataB(int selectedCourse) {
        ...
        if ((currentStudent.getMajor().equals("121 Інженерія програмного забезпечення")) && (selectedCourse == 1)) {
            ...
            enrollmentSystem.addDiscipline(new Discipline("314804", "Фізичне виховання", "викл. Жуков В. О.", 4, 65, MANDATORY_DISCIPLINE_CAPACITY, true, 1));
            ...
            enrollmentSystem.addDiscipline(new Discipline("315491", "Обчислювальне суспільствознавство", "проф. Глибовець А. М.", 2.5, 55, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("344466", "Вступ до ігрової розробки", "проф. Глибовець А. М.", 4, 52, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("344467", "Комп'ютерна мережа Інтернет", "ст. викл. Зважій Д. В.", 4, 12, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("344468", "Локальні мережі", "ст. викл. Вознюк Я. І.", 3, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340466", "Архітектура ПЕОМ", "проф. Глибовець А. М.", 3, 46, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("316200", "Додаткові розділи теорії графів", "ст. викл. Козеренко С. О.", 3, 62, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("319949", "Основи теорії груп", "ст. викл. Козеренко С. О.", 4, 19, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("315185", "Спектральна теорія графів", "ст. викл. Тимошкевич Л. М.", 3, 54, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340456", "Математичне мислення", "ст. викл. Щеглов М. В.", 3, 24, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("320163", "Обчислювальна геометрія", "доц. Чорней Р. К.", 4, 28, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("320012", "Мова розмітки LaTeX", "ст. викл. Зважій Д. В.", 4, 52, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("316847", "Математичні методи в хімії", "доц. Будзінська В. Л., ас. Носач В. В.", 3, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("316161", "Символьні обчислення", "ст. викл. Прокоф'єв П. Г.", 3, 41, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340446", "Додаткові розділи алгебри", "доц. Чорней Р. К.", 5, 54, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340445", "Додаткові розділи дискретної математики", "ст. викл. Щеглов М. В.", 5, 30, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340439", "Автоматизація роботи з програмними проєктами мовою Java", "ст. викл. Прокопенко П. О.", 3, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340393", "Інформаційний пошук", "доц. Мельничук А. В.", 3.5, 58, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("315191", "Методи та засоби збору чутливої інформації", "ст. викл. Бабич Т. А.", 2, 40, 40, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("315306", "Мова програмування Kotlin", "доц. Осадча Н. П.", 3, UNLIMITED_CAPACITY, UNLIMITED_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("315261", "Програмування на C#", "доц. Осадча Н. П.", 3, 30, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340402", "Розробка клієнт-серверних застосувань", "проф. Гришко О. М.", 4, 19, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340333", "Управління цифровим продуктом", "ст. викл. Сидорук І. Ю.", 3, 54, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340334", "Обробка зображень", "ст. викл. Сидорук І. Ю.", 3, 35, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340335", "Життя у цифровому світі", "доц. Сидоренко А. К.", 3, 14, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340336", "Введення у Хмарні технології", "ст. викл. Сидорчук Л. Н.", 3, 24, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            enrollmentSystem.addDiscipline(new Discipline("340337", "Мемологічні студії", "ст. викл. Ведель К. А.", 3, 18, MANDATORY_DISCIPLINE_CAPACITY, false, 2));
            ...
            enrollmentSystem.addDiscipline(new Discipline("316208", "Вступ до загальної топології", "ст. викл. Козеренко С. О.", 4, 63, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316210", "Загальна топологія", "ст. викл. Козеренко С.О.", 3, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316156", "Актуарна математика", "ст. викл. Братик М. В.", 5, 56, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("317933", "Обчислюваність", "проф. Олійник Б. В.", 4, 13, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316192", "Статистичні основи вебаналітики", "доц. Крюкова Г. В.", 4, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315490", "Дані та суспільство", "доц. Крюкова Г. В.", 4, 50, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("314810", "Експлуатація розподіленої хмарної інфраструктури та сервісів (DevOps)", "ст. викл. Сидорчук Л. Н.", 4, 20, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316195", "Візуалізація та комп'ютерна графіка", "доц. Крюковчук Г. В.", 4, 27, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315491", "Обчислювальне суспільствознавство", "проф. Глибовець А. М.", 2.5, 55, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("344466", "Вступ до ігрової розробки", "проф. Глибовець А. М.", 4, 14, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("344467", "Комп'ютерна мережа Інтернет", "ст. викл. Зважій Д. В.", 4, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("344468", "Локальні мережі", "ст. викл. Вознюк Я. І.", 3, 57, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340466", "Архітектура ПЕОМ", "проф. Глибовець А. М.", 3, 47, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316200", "Додаткові розділи теорії графів", "ст. викл. Козеренко С. О.", 3, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("319949", "Основи теорії груп", "ст. викл. Козеренко С. О.", 4, 22, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315185", "Спектральна теорія графів", "ст. викл. Тимошкевич Л. М.", 3, 18, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340456", "Математичне мислення", "ст. викл. Щеглов М. В.", 3, 47, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("320163", "Обчислювальна геометрія", "доц. Чорней Р. К.", 4, 22, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("320012", "Мова розмітки LaTeX", "ст. викл. Зважій Д. В.", 4, 62, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316847", "Математичні методи в хімії", "доц. Будзінська В. Л., ас. Носач В. В.", 3, 35, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316161", "Символьні обчислення", "ст. викл. Прокоф'єв П. Г.", 3, 57, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340446", "Додаткові розділи алгебри", "доц. Чорней Р. К.", 5, 15, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340445", "Додаткові розділи дискретної математики", "ст. викл. Щеглов М. В.", 5, 43, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340439", "Автоматизація роботи з програмними проєктами мовою Java", "ст. викл. Прокопенко П. О.", 3, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340393", "Інформаційний пошук", "доц. Мельничук  А. В.", 3.5, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315191", "Методи та засоби збору чутливої інформації", "ст. викл. Бабич Т. А.", 2, 12, 40, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315306", "Мова програмування Kotlin", "доц. Осадча Н. П.", 3, UNLIMITED_CAPACITY, UNLIMITED_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315261", "Програмування на C#", "доц. Осадча Н. П.", 3, 42, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340402", "Розробка клієнт-серверних застосувань", "проф. Гришко О. М.", 4, 19, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Управління цифровим продуктом", "ст. викл. Сидорук І. Ю.", 3, 30, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Обробка зображень", "ст. викл. Сидорук І. Ю.", 3, 52, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Життя у цифровому світі", "доц. Сидоренко А. К.", 3, 39, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Введення у Хмарні технології", "ст. викл. Сидорчук Л. Н.", 3, 38, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Мемологічні студії", "ст. викл. Ведель К. А.", 3, 46, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315293", "Інформаційна безпека вебзастосунків", "ст. викл. Бабич Т. А.", 4, 26, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315279", "Інструменти та принципи веброзробки", "ст. викл. Зважій Д. В.", 3, 57, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Архітектура високонавантажених систем", "ст. викл. Ведель К. А.", 2, 52, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315245", "Пошукова оптимізація вебзастосувань", "ст. викл. Цуд В. В.", 4, 16, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316198", "Комп'ютерна вірусологія", "ст. викл. Кирієнко О. В., ст. викл. Пєчкурова О. М.", 4, 58, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340384", "Архітектура прикладних програм рівня підприємства", "ст. викл. Ведель К. А.", 3, 24, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340303", "Глобальні мережі", "ст. викл. Ведель К. А.", 3, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("314833", "Низькорівневі вразливості програмного забезпечення", "ст. викл. Коренчук А. А.", 4, 34, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315253", "Кібербезпека", "ст. викл. Вознюк Я. І.", 4, 22, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315284", "Практичні аспекти роботи з базами даних в Spring Boot", "ст. викл. Андрощук М. В.", 3, 34, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("340321", "Технології обчислювального експерименту", "ст. викл. Міхновський О. Л.", 2, 31, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315211", "Програмування на основі .NET", "ст. викл. Борозенний С. О.", 4, 44, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315280", "Backend-розробка на базі NodeJS", "ст. викл. Петлюра С. І.", 4, 47, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("322535", "Алгоритми паралельних обчислень", "доц. Винниченко В. В.", 4, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315246", "Технології електронних видань", "ст. викл. Афонін А. О.", 4, 60, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315838", "Дизайн вебінтерфейсів", "ст. викл. Яковлєв М.В.", 3, 23, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("315479", "Інформаційна безпека мереж", "ст. викл. Коновалець Є. П.", 2, 16, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            enrollmentSystem.addDiscipline(new Discipline("316821", "Банківські комп'ютерні системи", "д. е. н., доц. Гладких Д. М.", 4, UNLIMITED_CAPACITY, MANDATORY_DISCIPLINE_CAPACITY, false, 3));
            ...
            enrollmentSystem.addDiscipline(new Discipline("316213", "Основи фінансової математики / Basics of Financial Mathematics (англ. мовою)", "доц. Щестюк Н. Ю.", 4, 44, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315991", "Системи та методи ухвалення рішеннь", "проф. Глибовець А. М.", 4, UNLIMITED_CAPACITY, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315491", "Обчислювальне суспільствознавство", "проф. Глибовець А. М.", 2.5, UNLIMITED_CAPACITY, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("344466", "Вступ до ігрової розробки", "проф. Глибовець А. М.", 4, 15, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("344467", "Комп'ютерна мережа Інтернет", "ст. викл. Зважій Д. В.", 4, 44, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("344468", "Локальні мережі", "ст. викл. Вознюк Я. І.", 3, 30, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340466", "Архітектура ПЕОМ", "проф. Глибовець А. М.", 3, 13, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316200", "Додаткові розділи теорії графів", "ст. викл. Козеренко С. О.", 3, 44, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("319949", "Основи теорії груп", "ст. викл. Козеренко С. О.", 4, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315185", "Спектральна теорія графів", "ст. викл. Тимошкевич Л. М.", 3, 41, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340456", "Математичне мислення", "ст. викл. Щеглов М. В.", 3, 51, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("320163", "Обчислювальна геометрія", "доц. Чорней Р. К.", 4, 30, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("320012", "Мова розмітки LaTeX", "ст. викл. Зважій Д. В.", 4, 37, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316847", "Математичні методи в хімії", "доц. Будзінська В. Л., ас. Носач В. В.", 3, 17, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316161", "Символьні обчислення", "ст. викл. Прокоф'єв П. Г.", 3, 61, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340446", "Додаткові розділи алгебри", "доц. Чорней Р. К.", 5, 54, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340445", "Додаткові розділи дискретної математики", "ст. викл. Щеглов М. В.", 5, 46, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340439", "Автоматизація роботи з програмними проєктами мовою Java", "ст. викл. Прокопенко П. О.", 3, 53, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340393", "Інформаційний пошук", "доц. Мельничук  А. В.", 3.5, 41, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315191", "Методи та засоби збору чутливої інформації", "ст. викл. Бабич Т. А.", 2, 26, 40, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315306", "Мова програмування Kotlin", "доц. Осадча Н. П.", 3, 44, UNLIMITED_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315261", "Програмування на C#", "доц. Осадча Н. П.", 3, 23, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340402", "Розробка клієнт-серверних застосувань", "проф. Гришко О. М.", 4, 45, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Управління цифровим продуктом", "ст. викл. Сидорук І. Ю.", 3, 12, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Обробка зображень", "ст. викл. Сидорук І. Ю.", 3, 43, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Життя у цифровому світі", "доц. Сидоренко А. К.", 3, 61, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Введення у Хмарні технології", "ст. викл. Сидорчук Л. Н.", 3, 62, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Мемологічні студії", "ст. викл. Ведель К. А.", 3, 62, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315293", "Інформаційна безпека вебзастосунків", "ст. викл. Бабич Т. А.", 4, 49, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315279", "Інструменти та принципи веброзробки", "ст. викл. Зважій Д. В.", 3, 42, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340351", "Архітектура високонавантажених систем", "ст. викл. Ведель К. А.", 2, 49, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315245", "Пошукова оптимізація вебзастосувань", "ст. викл. Цуд В. В.", 4, 63, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316198", "Комп'ютерна вірусологія", "ст. викл. Кирієнко О. В., ст. викл. Пєчкурова О. М.", 4, 19, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340384", "Архітектура прикладних програм рівня підприємства", "ст. викл. Ведель К. А.", 3, 56, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340303", "Глобальні мережі", "ст. викл. Ведель К. А.", 3, 58, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("314833", "Низькорівневі вразливості програмного забезпечення", "ст. викл. Коренчук А. А.", 4, 12, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315253", "Кібербезпека", "ст. викл. Вознюк Я. І.", 4, 28, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315284", "Практичні аспекти роботи з базами даних в Spring Boot", "ст. викл. Андрощук М. В.", 3, 22, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("340321", "Технології обчислювального експерименту", "ст. викл. Міхновський О. Л.", 2, 48, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315211", "Програмування на основі .NET", "ст. викл. Борозенний С. О.", 4, 39, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315280", "Backend-розробка на базі NodeJS", "ст. викл. Петлюра С. І.", 4, 15, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("322535", "Алгоритми паралельних обчислень", "доц. Винниченко В. В.", 4, 55, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315246", "Технології електронних видань", "ст. викл. Афонін А. О.", 4, 43, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315838", "Дизайн вебінтерфейсів", "ст. викл. Яковлєв М.В.", 3, 19, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315479", "Інформаційна безпека мереж", "ст. викл. Коновалець Є. П.", 2, 53, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316821", "Банківські комп'ютерні системи", "д. е. н., доц. Гладких Д. М.", 4, 44, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("313821", "Стандарти обміну даних в Інтернет", "д. е. н., доц. Гладких Д. М.", 3, 34, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("316472", "Методи та засоби офісного програмування", "д. е. н., доц. Гладких Д. М.", 4, 60, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315295", "Інформаційна безпека цільових систем", "ст. викл. Чередарчук А. І.", 3, 41, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315221", "Технологія XML", "ст. викл. Захоженко П. О.", 3, 43, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315241", "Розробка Frontend-додатків на JavaScript", "проф. Глибовець А. М., ст. викл. Бабич Т. А.", 3.5, 43, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("318273", "Алгоритми комп'ютерної алгебри", "ст. викл. Смиш О. Р.", 4, 56, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315297", "Вибрані фреймворки для iOS", "ст. викл. Франків О. О.", 3, 39, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315206", "Комп'ютерна графіка", "проф. Липинський І. С.", 4, 62, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
            enrollmentSystem.addDiscipline(new Discipline("315464", "Кваліфікаційна робота", "проф. Глибовець А. М.", 12, 60, MANDATORY_DISCIPLINE_CAPACITY, false, 4));
...
private void initializeInitialDataM(int selectedCourse) {
    ...
    if ((currentStudent.getMajor().equals("121 Інженерія програмного забезпечення")) && (selectedCourse == 1)) {
        ...
        enrollmentSystem.addDiscipline(new Discipline("317598", "Структури даних та аналіз алгоритмів", "ст. викл. Медвідь С. О.", 4, 65, MANDATORY_DISCIPLINE_CAPACITY, true, 1));
        ...
        enrollmentSystem.addDiscipline(new Discipline("317804", "Практика науково-дослідницька", "викл. Жуков В. О.", 3, 65, MANDATORY_DISCIPLINE_CAPACITY, true, 1));
