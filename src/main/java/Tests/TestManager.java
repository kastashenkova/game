    ...
    public void generateQuestions(Discipline discipline) {
        if (discipline.getName().equals("Забезпечення якости доступу програмних продуктів"))
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("3. Що таке скалярний добуток векторів \\( \\vec{a} \\cdot \\vec{b} \\)?",
                            new String[]{"Результат у вигляді вектора", "Добуток координат", "Число, яке дорівнює сумі добутків відповідних координат", "Вектор перпендикулярний до обох"}, 2),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("3. Яка з наведених складностей є найгіршою за продуктивністю?",
                            new String[]{"O(1)", "O(log n)", "O(n)", "O(n^2)"}, 3),
                    ...
                    new Question("13. Яка структура найкраще підходить для реалізації черги?",
                            new String[]{"Стек", "Масив", "Зв’язаний список", "Очередь (Queue)"}, 3),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("2. Яка норма визначена в просторі \\( \\ell^2 \\)?",
                            new String[]{"Максимальне значення", "Сума модулів", "Корінь із суми квадратів координат", "Мінімум значень"}, 2),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("4. У якій ситуації застосовується мінімаксна стратегія?",
                            new String[]{"У кооперативних іграх", "У випадкових іграх", "У двохосібних антагоністичних іграх", "У стохастичних процесах"}, 2),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("8. Що таке абстракція в ООП?",
                            new String[]{"Сховання всієї логіки", "Створення класу без властивостей", "Виділення суттєвих характеристик", "Повне дублювання коду"}, 2),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("12. Що таке преривання (interrupt)?",
                    ...
                    new Question("13. Яка програма компілює код асемблера?",
                            new String[]{"Компоновник", "Інтерпретатор", "Ассемблер", "Редактор коду"}, 2),
            ...
            discipline.questions = new Question[]{
                    ...
                    new Question("12. Що таке однов’язна область?",
